...
setup(
    name='jlabdev',
    version=__version__,
    description='A small simple tool to develop python from jupyterlab notebooks.',
    long_description=long_description,
    url='https://github.com/penguinmenac3/jlabdev',
    download_url='https://github.com/penguinmenac3/jlabdev/tarball/' + __version__,
    license='MIT',
